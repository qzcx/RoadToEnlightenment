	...
	var PlayerWaitingView = (function makeGameListView(){
		...
		function makeRactiveView(body){	
			...
			var template = 
                ...
                + '{{^adding}}'
                + '<form>'
                + '<label>Start game with current players:</label>'
                + '</form><button proxy-click="StartGame" class="button-area full tall">Start!</button>'
                + '{{/adding}}'
            ...
            ractive.on( 'StartGame', function (event){
                window.location="/setup.html";
            })
			console.log(ractive)
