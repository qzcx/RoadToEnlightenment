...
catan.views.overlays.MapOverlay = (function (){
   ...
   var MapOverlay = (function MapOverlayFunction(){
		...
		MapOverlay.prototype.RteMsg = function(type){
			switch(type){
				case "robber":
					return "Incite a rebellion";
				case "soldier":
					return "Deploy your privateers";
				case "city":
					return "Industrialize which canton";
				case "settlement":
					return "Place a canton";
				case "road":
					return "Place a railroad";
				default:
					return "RteMsg Error";
			}
		}
        ...
        MapOverlay.prototype.showModal = function(type){
			...
			var RTE_msg = this.RteMsg(type.toLowerCase());

			var modal = new NinjaModal(RTE_msg, 
				'map-play',
