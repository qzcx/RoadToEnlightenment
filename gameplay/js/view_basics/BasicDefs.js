...
catan.definitions = {
	...
	CardInfo :{
		soldier: "Privateer: Send Privateers to steal resources. The size of your navy increases.",
		yearOfPlenty: "Mercantilism: Use your colonial power to gain two resources",
		monopoly: "Royal Charter: Pick a resource to sponsor.",
		roadBuilding: "Steam Engine: A new invention expands your railroad network!",
		monument: "Invention: Your scientists invented something new!"
	},
	PointImages :{
